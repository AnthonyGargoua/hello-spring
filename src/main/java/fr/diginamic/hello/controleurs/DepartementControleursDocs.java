 ...
 * sont portés par {@link DepartementControleur}.
 */
public interface DepartementControleursDocs {
    ...
    ResponseEntity<String> insertDepartement(DepartementDto nouveauDepartementDto) throws VilleException;
    ...
    ResponseEntity<String> updateDepartement(
            ...
            int id,
            DepartementDto departementModifieDto) throws VilleException;
    ...
    ResponseEntity<byte[]> exporterDepartementPdf(
            ...
            String code) throws VilleException;
}
